...
(
	P_PREGUNTA PREGUNTAS.ID_PRE%TYPE,
	P_TEXTO PREGUNTAS.TEXTO%TYPE,
  P_CORRECTA PREGUNTAS.CORRECTA%TYPE
)
AS
...
BEGIN
	...
	SELECT ID_CAT INTO V_ID_CATEGORIA FROM CATEGORIAS WHERE NOMBRE = P_CATEGORIA;
	INSERT INTO RESPUESTAS(ID_RES, TEXTO, CORRECTA) VALUES(V_ID, P_TEXTO, P_CORRECTA, P_PREGUNTA);
